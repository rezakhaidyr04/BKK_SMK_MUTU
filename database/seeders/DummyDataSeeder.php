...
class DummyDataSeeder extends Seeder
{
    ...
    private function createCompanies(): array
    {
        $data = [
            ...
            // Subang
            [
                'email' => 'pt.prima.subang@gmail.com',
                'name'  => 'PT Prima Agro Subang',
                'industry' => 'Pertanian & Perkebunan',
                'description' => 'Perusahaan agroindustri yang mengelola kebun tebu dan pabrik gula terbesar di Subang.',
                'website' => 'https://primaagrosubang.co.id',
                'address' => 'Jl. Raya Subang-Bandung No. 10, Subang',
            ],
            [
                'email' => 'pt.textile.subang@gmail.com',
                'name'  => 'PT Tekstil Jaya Subang',
                'industry' => 'Tekstil & Garment',
                'description' => 'Pabrik tekstil dan garment ekspor yang berlokasi di kawasan industri Subang.',
                'website' => 'https://tekstiljaya.subang.co.id',
                'address' => 'Kawasan Industri Subang, Jl. Otista No. 25',
            ],
            // Purwakarta
            [
                'email' => 'pt.metal.purwakarta@gmail.com',
                'name'  => 'PT Metal Purwakarta',
                'industry' => 'Manufaktur & Logam',
                'description' => 'Perusahaan manufaktur komponen logam otomotif untuk pasar domestik dan ekspor.',
                'website' => 'https://metalpurwakarta.co.id',
                'address' => 'Jl. Industri Purwakarta No. 8',
            ],
            [
                'email' => 'pt.food.purwakarta@gmail.com',
                'name'  => 'PT Purwakarta Food Industries',
                'industry' => 'Makanan & Minuman',
                'description' => 'Perusahaan makanan dan minuman ringan dengan merek terkenal nasional.',
                'website' => 'https://pfruits.co.id',
                'address' => 'Jl. Raya Purwakarta-Karawang No. 15',
            ],
        ];
    ...
    private function createJobs(array $companies): array
    {
        $jobsData = [
            ...
            // PT Prima Agro Subang
            [
                'company_index' => 6,
                'title'       => 'Operator Mesin Pertanian',
                'position'    => 'Operator',
                'location'    => 'Subang',
                'job_type'    => 'full_time',
                'salary_min'  => 3200000,
                'salary_max'  => 4200000,
                'description' => "Dibutuhkan operator mesin pertanian untuk mengoperasikan alat berat dan mesin panen di kebun tebu.\n\nTanggung jawab:\n- Mengoperasikan mesin panen tebu\n- Melakukan perawatan harian mesin\n- Melaporkan kondisi kebun ke supervisor\n- Bekerja sesuai jadwal tanam dan panen",
                'qualifications' => "- Lulusan SMK Teknik Pertanian / Teknik Mesin\n- Bersedia kerja di area kebun\n- Fisik sehat dan kuat\n- Bisa bekerja dalam tim\n- Memiliki SIM A atau B1 diutamakan",
                'benefits'    => "- Gaji + uang transport harian\n- BPJS Kesehatan & Ketenagakerjaan\n- Tunjangan beras\n- Tempat tinggal disediakan",
                'status'      => 'active',
                'deadline'    => Carbon::now()->addDays(25),
            ],
            [
                ...
                'salary_min'  => 2800000,
                'salary_max'  => 3500000,
                'description' => "Dibutuhkan staf gudang untuk mengelola stok gula dan bahan baku di pabrik.\n\nTanggung jawab:\n- Mengatur masuk keluar barang\n- Melakukan stock opname berkala\n- Menjaga kebersihan gudang\n- Membuat laporan inventaris",
                'qualifications' => "- Lulusan SMK Akuntansi / Administrasi\n- Teliti dan terorganisir\n- Bisa mengoperasikan forklift (diutamakan)\n- Menguasai Excel",
                'benefits'    => "- Gaji pokok + tunjangan shift\n- BPJS lengkap\n- Makan siang gratis",
                'status'      => 'active',
                'deadline'    => Carbon::now()->addDays(20),
            ],

            // PT Tekstil Jaya Subang
            [
                'company_index' => 7,
                'title'       => 'Operator Mesin Jahit',
                'position'    => 'Operator',
                'location'    => 'Subang',
                'job_type'    => 'full_time',
                'salary_min'  => 2500000,
                'salary_max'  => 3500000,
                'description' => "Dicari operator mesin jahit yang berpengalaman untuk lini produksi garment ekspor.\n\nTanggung jawab:\n- Mengoperasikan mesin jahit sesuai standar\n- Menjaga kualitas jahitan sesuai template\n- Menyelesaikan target produksi harian\n- Menjaga kebersihan area kerja",
                'qualifications' => "- Lulusan SMK Tata Busana / garmen\n- Pengalaman min. 1 tahun (fresh graduate diterima)\n- Teliti dan cekatan\n- Bersedia kerja shift",
                'benefits'    => "- Gaji UMR Subang\n- BPJS Kesehatan\n- THR tahunan\n- Bonus produksi",
                'status'      => 'active',
                'deadline'    => Carbon::now()->addDays(30),
            ],
            [
                ...
                'salary_min'  => 3000000,
                'salary_max'  => 4000000,
                'description' => "Dibutuhkan QC untuk memastikan kualitas produk garment sebelum dikirim ke pelanggan.\n\nTanggung jawab:\n- Memeriksa kualitas produk secara visual\n- Mengukur dimensi sesuai spesifikasi\n- Membuat laporan QC harian\n- Memberikan feedback ke lini produksi",
                'qualifications' => "- Lulusan SMK Teknik Tekstil / Administrasi\n- Teliti dan jeli melihat detail\n- Bisa menggunakan alat ukur dasar\n- Komunikatif",
                'benefits'    => "- Gaji + tunjangan\n- BPJS lengkap\n- Pelatihan QC",
                'status'      => 'active',
            ...
            [
                ...
                'salary_min'  => 4000000,
                'salary_max'  => 6000000,
                'description' => "Dibutuhkan teknisi CNC berpengalaman untuk mengoperasikan mesin CNC di pabrik komponen otomotif.\n\nTanggung jawab:\n- Mengoperasikan mesin CNC milling dan turning\n- Setting tool dan program\n- Melakukan inspeksi dimensi produk\n- Melakukan perawatan mesin",
                'qualifications' => "- Lulusan SMK/D3 Teknik Mesin\n- Pengalaman min. 2 tahun di CNC\n- Bisa membaca gambar teknik\n- Menguasai G-Code dan M-Code",
                'benefits'    => "- Gaji kompetitif\n- BPJS Kesehatan & Ketenagakerjaan\n- Tunjangan shift\n- Pelatihan Jepang",
                'status'      => 'active',
                'deadline'    => Carbon::now()->addDays(35),
            ],
            [
                ...
                'salary_min'  => 6000000,
                'salary_max'  => 9000000,
                'description' => "Dibutuhkan kepala produksi untuk mengawasi lini manufaktur komponen logam.\n\nTanggung jawab:\n- Mengawasi operasional harian produksi\n- Memastikan target produksi tercapai\n- Mengelola tim operator mesin\n- Melaporkan produksi ke manajemen",
                'qualifications' => "- Lulusan D3/S1 Teknik Mesin\n- Pengalaman min. 3 tahun di manufaktur\n- Leadership yang baik\n- Menguasai sistem manufaktur",
                'benefits'    => "- Gaji besar + tunjangan jabatan\n- BPJS lengkap\n- Mobil dinas\n- Bonus tahunan",
                'status'      => 'active',
                'deadline'    => Carbon::now()->addDays(40),
            ],

            // PT Purwakarta Food Industries
            [
                'company_index' => 9,
                'title'       => 'Operator Packaging',
                'position'    => 'Operator',
                'location'    => 'Purwakarta',
                'job_type'    => 'full_time',
                'salary_min'  => 2700000,
                'salary_max'  => 3300000,
                'description' => "Dibutuhkan operator packaging untuk lini pengemasan produk makanan ringan.\n\nTanggung jawab:\n- Mengoperasikan mesin packaging\n- Memastikan kemasan rapi dan tertutup sempurna\n- Menjaga kebersihan area packaging\n- Melaporkan kerusakan mesin",
                'qualifications' => "- Lulusan SMA/SMK sederajat\n- Teliti dan cekatan\n- Bersedia kerja shift\n- Sehat jasmani",
                'benefits'    => "- Gaji + uang makan\n- BPJS Kesehatan\n- THR\n- Bonus produksi bulanan",
                'status'      => 'active',
            ...
            [
                ...
                'salary_min'  => 3500000,
                'salary_max'  => 5000000,
                'description' => "Dibutuhkan staff marketing untuk memasarkan produk makanan ke toko dan retailer.\n\nTanggung jawab:\n- Mengunjungi toko dan retailer\n- Memasarkan produk baru\n- Mengelola data penjualan\n- Mencapai target penjualan bulanan",
                'qualifications' => "- Lulusan SMK/D3 Marketing / Bisnis\n- Komunikatif dan ramah\n- Memiliki kendaraan sendiri\n- Bersedia keliling area Jawa Barat",
                'benefits'    => "- Gaji + komisi penjualan\n- BPJS lengkap\n- Uang bensin\n- Bonus target",
                'status'      => 'active',
