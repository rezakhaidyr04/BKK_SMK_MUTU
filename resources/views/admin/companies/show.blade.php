                ...
                <div class="lg:col-span-1 space-y-5">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-blue-200">
                        ...
                        <form method="POST" action="{{ route('admin.companies.create-account', $company) }}"
                              class="p-5 space-y-3" data-confirm="Buat akun login untuk {{ $company->name }}?

Password sementara akan ditampilkan SEKALI. Pastikan Anda siap mencatatnya." data-confirm-title="Buat Akun" data-confirm-ok="Buat Akun">
                            @csrf
                            <div>
