...
<div class="min-h-screen bg-slate-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {{-- Kartu Pengguna --}}
            <div style="background:var(--white);border-radius:20px;border:1px solid var(--border);box-shadow:0 1px 8px rgba(15,23,42,0.06);padding:24px;">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
                    <h3 style="font-weight:700;font-size:15px;color:var(--text);">Data Pengguna</h3>
                ...
                <div style="space-y:12px;">
                    <div style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:var(--bg-soft);border-radius:12px;margin-bottom:10px;">
                        ...
                        <span style="font-size:20px;font-weight:800;color:var(--navy-3);">{{ number_format($summary['total_umum']) }}</span>
                    </div>
                    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;background:linear-gradient(135deg,var(--primary),var(--primary));border-radius:12px;">
            ...
            <div style="background:var(--white);border-radius:20px;border:1px solid var(--border);box-shadow:0 1px 8px rgba(15,23,42,0.06);padding:24px;">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
                    <h3 style="font-weight:700;font-size:15px;color:var(--text);">Data Lowongan</h3>
                ...
                <div>
                    <div style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:var(--bg-soft);border-radius:12px;margin-bottom:10px;">
                        ...
                        <span style="font-size:20px;font-weight:800;color:var(--text);">{{ number_format($summary['total_jobs']) }}</span>
                    </div>
            ...
            @php
                $rate = $summary['total_applications'] > 0
                    ...
                    : 0;
            @endphp
            <div style="background:linear-gradient(145deg,var(--navy-3),var(--navy-2));border-radius:20px;box-shadow:0 8px 32px rgba(23,61,145,0.35);padding:24px;color:#fff;display:flex;flex-direction:column;justify-content:space-between;">
                <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div style="background:var(--white);border-radius:20px;border:1px solid var(--border);box-shadow:0 1px 8px rgba(15,23,42,0.06);padding:24px;" class="lg:col-span-3">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;">
                    <div>
                        <h3 style="font-weight:700;font-size:15px;color:var(--text);">Tren Lamaran</h3>
                        <p style="font-size:12px;color:var(--text-3);margin-top:2px;">6 bulan terakhir</p>
                    </div>
                    <span style="font-size:11px;font-weight:600;padding:4px 10px;background:var(--primary-light);color:var(--primary);border-radius:99px;">Per Bulan</span>
                </div>
                ...
                <div style="display:flex;align-items:flex-end;gap:12px;height:160px;">
                    ...
                    <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;height:100%;">
                        ...
                        <div style="flex:1;width:100%;display:flex;align-items:flex-end;">
                            <div style="width:100%;height:{{ max($pct, 3) }}%;background:linear-gradient(180deg,#3b82f6,var(--primary));border-radius:8px 8px 4px 4px;min-height:6px;transition:height 0.5s ease;box-shadow:0 4px 12px rgba(99,102,241,0.25);"></div>
                        </div>
                        <span style="font-size:10px;color:var(--text-3);text-align:center;white-space:nowrap;">{{ $month['label'] }}</span>
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            <div style="background:var(--white);border-radius:20px;border:1px solid var(--border);box-shadow:0 1px 8px rgba(15,23,42,0.06);padding:24px;" class="lg:col-span-2">
                <h3 style="font-weight:700;font-size:15px;color:var(--text);margin-bottom:20px;">Status Lamaran</h3>
                @php
                    $statuses = [
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {{-- Pengguna Terbaru --}}
            <div style="background:var(--white);border-radius:20px;border:1px solid var(--border);box-shadow:0 1px 8px rgba(15,23,42,0.06);overflow:hidden;">
                <div style="display:flex;align-items:center;justify-content:space-between;padding:18px 24px;border-bottom:1px solid var(--border);">
                    <h3 style="font-weight:700;font-size:15px;color:var(--text);">Pengguna Terbaru</h3>
                    <a href="{{ route('admin.users.index') }}" style="font-size:12px;font-weight:600;color:var(--primary);text-decoration:none;">Lihat Semua ?</a>
                </div>
                ...
                @endphp
                <div style="display:flex;align-items:center;gap:12px;padding:14px 24px;border-bottom:1px solid var(--bg-soft);transition:background 0.15s;" onmouseover="this.style.background='var(--bg-soft)'" onmouseout="this.style.background='transparent'">
                    <div style="width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#3b82f6,var(--primary));display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:14px;flex-shrink:0;">
                        {{ strtoupper(substr($user->name,0,1)) }}
                    </div>
                    <div style="flex:1;min-width:0;">
                        <p style="font-weight:600;font-size:14px;color:var(--text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">{{ $user->name }}</p>
                        <p style="font-size:12px;color:var(--text-3);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">{{ $user->email }}</p>
                    </div>
                ...
                @empty
                <div style="padding:40px;text-align:center;color:var(--text-3);font-size:14px;">Belum ada pengguna.</div>
                @endforelse
            </div>
            ...
            <div style="background:var(--white);border-radius:20px;border:1px solid var(--border);box-shadow:0 1px 8px rgba(15,23,42,0.06);overflow:hidden;">
                <div style="display:flex;align-items:center;justify-content:space-between;padding:18px 24px;border-bottom:1px solid var(--border);">
                    <h3 style="font-weight:700;font-size:15px;color:var(--text);">Lowongan Terbaru</h3>
                    <a href="{{ route('admin.jobs.index') }}" style="font-size:12px;font-weight:600;color:var(--primary);text-decoration:none;">Lihat Semua ?</a>
                </div>
                ...
                <div style="display:flex;align-items:center;gap:12px;padding:14px 24px;border-bottom:1px solid var(--bg-soft);transition:background 0.15s;" onmouseover="this.style.background='var(--bg-soft)'" onmouseout="this.style.background='transparent'">
                    ...
                    <div style="flex:1;min-width:0;">
                        <p style="font-weight:600;font-size:14px;color:var(--text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">{{ $job->title }}</p>
                        <p style="font-size:12px;color:var(--text-3);">{{ $job->company_name ?? '-' }} &middot; {{ $job->applications_count }} pelamar</p>
                    </div>
                ...
                @empty
                <div style="padding:40px;text-align:center;color:var(--text-3);font-size:14px;">Belum ada lowongan.</div>
                @endforelse
            </div>
        </div>
