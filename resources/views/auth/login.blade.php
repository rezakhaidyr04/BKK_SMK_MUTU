<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600">Masuk untuk mengakses dasbor karir Anda</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                <x-text-input id="email" class="form-input pl-12" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Masukkan alamat email Anda" />
        ...
        <div>
            ...
            <div class="relative">
                <x-text-input id="password" class="form-input pl-12" type="password" name="password" required autocomplete="current-password" placeholder="Masukkan kata sandi Anda" />
                <div class="absolute left-4 top-1/2 transform -translate-y-1/2">
                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mt-8 p-4 bg-blue-50 rounded-xl">
        <h4 class="text-sm font-semibold text-blue-900 mb-2">Jenis Akun</h4>
        <div class="grid grid-cols-1 gap-2 text-xs text-blue-700">
            <div class="flex items-center gap-2">
                <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                <span>Siswa & Alumni - Melamar pekerjaan, membuat CV</span>
            </div>
            <div class="flex items-center gap-2">
                <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                <span>Perusahaan - Memasang lowongan, mencari talenta</span>
            </div>
            <div class="flex items-center gap-2">
