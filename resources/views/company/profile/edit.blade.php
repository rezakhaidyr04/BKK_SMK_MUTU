                        ...
                        <div class="rounded-xl bg-slate-50 border border-slate-200 p-4 space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $company->name ?? '') }}" class="w-full px-3.5 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 shadow-sm hover:border-slate-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition" placeholder="PT Nama Perusahaan" />
