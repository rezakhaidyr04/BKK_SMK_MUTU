            ...
            <div class="p-6 sm:p-8 bg-white/80 backdrop-blur-xl shadow sm:rounded-2xl border border-gray-100">
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        ...
                        <h2 class="mt-3 text-2xl font-bold text-gray-900">Update informasi & keamanan akun</h2>
                        <p class="mt-1 text-sm text-gray-600">Kelola profil, password, dan hapus akun kapan saja.</p>
                    </div>
